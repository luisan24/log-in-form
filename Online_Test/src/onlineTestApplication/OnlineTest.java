...
public class OnlineTest extends JFrame implements ActionListener {
	...
	void set() {
		...
		if (current == 2) {
			label.setText("Que3: Which package is directly available to our class without impoting it?");
			radioButton[0].setText("swing");
			radioButton[1].setText("applet");
		...
		if (current == 3) {
			label.setText("Que4: String class defined in which package?");
		...
		if (current == 4) {
			...
			radioButton[0].setText("Guru99");
			radioButton[1].setText("ABC");
			radioButton[2].setText("XYZ");
			radioButton[3].setText("123");
		}
		if (current == 5) {
